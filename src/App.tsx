        ...
        <div className='flex gap-3 max-w-xl flex-col items-center md:gap-4'>
          <div className='relative'>
            ...
            <a href='https://github.com/abdadjal'>
              <img src={github} className='size-6 rounded-full absolute bottom-[-3%] right-[5%] backdrop-blur-md md:size-8 lg:size-10 md:bottom-[-1%] md:right[7%]'/>
            </a>
          </div>
          ...
          <a className='flex items-center gap-[0.35rem] px-3 py-1 bg-black ring-1 ring-white ring-opacity-15 rounded-full hover:ring-opacity-30 transition-all duration-300 text-sm' href={resume} download>
